...
http.createServer(function (request, response) {
    ...
    switch (incomingUrl.pathname) {
        case '/cilindro':
            ...
            break;
        case '/esfera':
            const radioEsfera = (incomingUrl.searchParams.get('radioEsfera'))
            let areaEsfera = calcularAreaEsfera(radioEsfera)
            if (areaEsfera) {
